...
function IconExclamationTriangle({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      width="15"
      height="15"
...
function IconSparkles({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M5 3V7V3ZM3 5H7H3ZM6 17V21V17ZM4 19H8H4ZM13 3L15.286 9.857L21 12L15.286 14.143L13 21L10.714 14.143L5 12L10.714 9.857L13 3Z" 
        stroke="currentColor"
        stroke-width="2"
...
function IconPaperclip({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M14.9152 9.20096L8.3101 15.8061C6.51233 17.6038 3.81613 17.8161 1.98318 15.9832C0.18541 14.1854 0.419062 11.5809 2.25201 9.74799L9.67685 2.32315C10.8132 1.18679 12.6426 1.18679 13.779 2.32315C14.9154 3.45951 14.9154 5.28895 13.779 6.42531L6.22379 13.9805C5.6574 14.5469 4.7391 14.5469 4.17272 13.9805C3.60633 13.4141 3.60633 12.4958 4.17272 11.9294L10.9082 5.19396" 
        stroke-linecap="round"
        strokeWidth='1'
        stroke="#919191"
      />
